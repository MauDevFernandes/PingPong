...
function drawComputerPaddle()
{
    ...
    {
        computerPosition += computerSpeed; //Computer moves down
    } else if (ballY < computerPosition - paddleHeight / 4)
    {
        computerPosition -= computerSpeed; //Computer moves up
    }
...
// This will be called to identify and give points to the correct side, while also calling endgame function and resetting the ball speed and position
